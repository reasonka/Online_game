...
public class CookingStation : MonoBehaviourPun
{
    ...
    public void AddIngredient(string ingredientId)
    {
        ...
        /*
         * ���� RpcTarget.All��
         * ˭���� CookingStation��˭���ؼ��� recipe��
         * ���ɳ����� visual / final product ���� PhotonNetwork.Instantiate��
         * ����������Ҷ��ܿ��������
         */
        ...
        CookingRecipe recipe)
    {
        ...
        SFXManager.Instance?.PlayFoodCookedSuccess();
    ...
    private void HandleFailedRecipe(string reason)
    {
        ...
        SFXManager.Instance?.PlayFoodCookedFail();
